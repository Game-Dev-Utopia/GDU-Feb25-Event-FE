...
const TermsAndConditions = () => {
  return (
    <div className="p-6 bg-gray-100 text-gray-800 rounded-lg shadow-lg max-w-4xl mx-auto mt-16">
      ...
      <p className="mb-4">
        ...
        agreement by and between MIHIR CHANDRASHEKHAR RANADE (“Website Owner” or “we” or
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          such other policies of such third parties.
        </li>
      </ul>
    </div>
  );
