...
import { postRequest, postRequestJsonwithHeader } from '../../api/api';
    ...
    <>
      ...
      >
        <div className="p-0 h-full relative">
          ...
          <div
            className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-stone-900 to-transparent p-6 transform transition-all duration-300 ${showReadMore ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'
              }`}
          >
            <button
