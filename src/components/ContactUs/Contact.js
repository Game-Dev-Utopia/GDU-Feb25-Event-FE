    ...
    <div className="p-5">
      ...
      <div className="relative w-full max-w-xl bg-charcoalGray bg-opacity-50 p-5 md:p-6 rounded-lg shadow-lg z-20 text-goldenrod 
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label htmlFor="name" className="block text-lg focus:outline-none">
              Name
            </label>
            <input
              type="text"
              ...
              required
              className="w-full px-4 py-2 rounded-lg bg-[#333333] border border-burntOrange focus:outline-none"
            />
          </div>
          <div>
            <label htmlFor="email" className="block text-lg focus:outline-none">
              Email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="contact" className="block text-lg focus:outline-none">
              Contact
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="message" className="block text-lg focus:outline-none">
              Message
            </label>
            <textarea
              id="message"
